...
export class Slider extends Focusable {
    ...
    updateTickLabels(slot) {
        const nodes = slot.assignedNodes();
        this.tickLabelElements = nodes.filter((node) => node instanceof TickLabel);
        this.requestUpdate();
    }
    render() {
        return html `
    ...
    tickLabelText(i) {
        ...
        if (this.tickLabelElements.length) {
            return ((_a = this.tickLabelElements[i]) === null || _a === void 0 ? void 0 : _a.textContent) || `${i * tickStep}`;
        }
        return `${i * tickStep}`;
    }
    tickLabelClassNames(i) {
        var _a;
        if ((_a = this.tickLabelElements[i]) === null || _a === void 0 ? void 0 : _a.hasAttribute('highlight')) {
